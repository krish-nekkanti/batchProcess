 ...
 */
public class WSMionlineStatus implements Serializable
{
    ...
    private static String WS_MSG_STATUS = "WSClientMionline webservice call failed: errorcode.desc.src=";
    private static String WS_MSGSEP = "..";
    private static String STATUS_NO_USER_FOR_REP = "203";
    private static String STATUS_REP_NOT_FOUND = "206";

	/**
	 * default constructor
	 */
	public WSMionlineStatus()
	{
	}
	 ...
	 * @return msg
	 */
	public String getExceptionMsg(WSMionlineStatus status)
	{
	...
	/**
	 * @return true if error status is that the repID was not found for GetRepInfo call
	 */
	public boolean isRepNotFound()
	{
		if (getErrorcode().length() > 0)
		{
			if (getErrorcode().equals(STATUS_NO_USER_FOR_REP) ||
				getErrorcode().equals(STATUS_REP_NOT_FOUND))
